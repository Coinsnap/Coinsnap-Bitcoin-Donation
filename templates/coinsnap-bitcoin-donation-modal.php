...
<div id="<?php echo esc_html($prefix); ?>qr-container<?php echo esc_html($sufix); ?>" class="qr-container coinsnap-bitcoin-donation" data-public-donors="<?php echo esc_attr($public_donors); ?>">
    ...
    <div id="<?php echo esc_html($prefix); ?>public-donor-popup<?php echo esc_html($sufix); ?>" class="public-donor-popup">
        ...
        <form class="public-donor-form">
            ...
            <?php if ($address !== 'hidden'): ?>
                ...
                <div class="address-grid">
                    <div class="address-row">
                        ...
                        <div class="address-cell quart">
                        <input <?php echo $address === 'mandatory' ? 'require   d' : ''; ?>
                            type="text"
            ...
            <?php endif; ?>
            <button type="submit" id="<?php echo esc_html($prefix); ?>public-donors-pay<?php echo esc_html($sufix); ?>"><?php esc_html_e('Pay with Bitcoin', 'coinsnap-bitcoin-donation');?></button>
        </form>
    </div>
    ...
    <div id="<?php echo esc_html($prefix); ?>payment-popup<?php echo esc_html($sufix); ?>" class="payment-popup">
        ...
        <div style="position: relative;">
            ...
            <img class="qr-code-btc" id="<?php echo esc_html($prefix);?>qrCodeBtc<?php echo esc_html($sufix);?>" alt="QR Code Btc" src="<?php echo esc_url(COINSNAP_BITCOIN_DONATION_PLUGIN_DIR . 'assets/images/bitcoinqr.svg');?>">
        </div>
        <details open class="qr-details">
            ...
            <div class="qr-address-wrapper" id="<?php echo esc_html($prefix); ?>lightning-wrapper<?php echo esc_html($sufix); ?>" style="display: none; margin-top:8px">
                <div class="qr-address-title">
                    <?php esc_html_e('Lightning', 'coinsnap-bitcoin-donation');?>:
                </div>
            ...
            <div id="<?php echo esc_html($prefix); ?>btc-wrapper<?php echo esc_html($sufix); ?>" style="display: none; margin-top:12px" class="qr-address-wrapper">
                <div class="qr-address-title">
                    <?php esc_html_e('Address', 'coinsnap-bitcoin-donation');?>:
                </div>
        ...
        <a id="<?php echo esc_html($prefix); ?>pay-in-wallet<?php echo esc_html($sufix); ?>" class="qr-pay-in-wallet"><?php esc_html_e('Pay in wallet','coinsnap-bitcoin-donation');?></a>
    </div>
