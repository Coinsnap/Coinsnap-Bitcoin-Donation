...
if ( ! defined( 'COINSNAP_BITCOIN_DONATION_VERSION' ) ) { define( 'COINSNAP_BITCOIN_DONATION_VERSION', '1.5.1' ); }
...
function coinsnap_bitcoin_donation_run_upgrade() {
    ...
    if ( version_compare( $current_version, '1.5.1', '>=' ) ) {
        return;
    }
    ...
    update_option( $version_key, '1.5.1' );
}
