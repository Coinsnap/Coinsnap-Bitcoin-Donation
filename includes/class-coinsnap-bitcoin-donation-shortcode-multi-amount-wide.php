...
class Coinsnap_Bitcoin_Donation_Shortcode_Multi_Amount_Wide {
    ...
    public function __construct() {
        add_shortcode( 'multi_amount_donation_wide', array( $this, 'render' ) );
    }

    public function render( $atts ) {
        $post_id = Coinsnap_Bitcoin_Donation_Form_Renderer::resolve_legacy_shortcode( 'multi_amount_donation_wide' );
        if ( $post_id ) {
            return Coinsnap_Bitcoin_Donation_Form_Renderer::render_form( array( 'id' => $post_id, 'layout' => 'WIDE' ) );
        }
                ...
                <div class="coinsnap-bitcoin-donation-wide-up">
                    <div class="mulit-wide-label-left">
                        ...
                        <div class="amount-wrapper">
                            ...
                            <span class="donation-amount-currency" id="coinsnap-bitcoin-donation-currency-label-multi-wide"><?php echo esc_html( $default_currency ); ?></span>
