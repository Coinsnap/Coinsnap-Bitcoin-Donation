...
?>
        <table class="form-table">
            <tr>
                ...
                <td>
                    <input type="text" id="bitcoin_donation_donor_name" name="bitcoin_donation_donor_name" class="regular-text" value="<?php echo esc_attr($name); ?>">
                </td>
            </tr>
            <tr>
                <th scope="row">
                ...
                <td>
                    <input type="text" id="bitcoin_donation_amount" name="bitcoin_donation_amount" class="regular-text" value="<?php echo esc_attr($amount); ?>">
                </td>
            </tr>
            <tr>
                <th scope="row">
                ...
                <td>
                    <textarea id="bitcoin_donation_message" name="bitcoin_donation_message" class="regular-text" rows="3"><?php echo esc_textarea($message); ?></textarea>
                </td>
            </tr>
            <tr>
                <th scope="row">
                ...
                <td>
                    <input type="text" id="bitcoin_donation_form_type" name="bitcoin_donation_form_type" class="regular-text" value="<?php echo esc_attr($form_type); ?>">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <label>
                        <input type="checkbox" name="bitcoin_donation_dont_show" value="1" <?php checked($dont_show, '1'); ?>>
                        Enable
                    </label>
                </td>
            </tr>
