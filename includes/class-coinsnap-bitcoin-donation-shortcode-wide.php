...
class Coinsnap_Bitcoin_Donation_Shortcode_Wide {
    ...
    public function __construct() {
        add_shortcode( 'coinsnap_bitcoin_donation_wide', array( $this, 'render' ) );
    }

    public function render( $atts ) {
        $post_id = Coinsnap_Bitcoin_Donation_Form_Renderer::resolve_legacy_shortcode( 'coinsnap_bitcoin_donation_wide' );
        if ( $post_id ) {
