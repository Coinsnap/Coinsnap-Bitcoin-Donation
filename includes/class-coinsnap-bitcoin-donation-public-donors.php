...
<?php
    ...
    public function save_public_donors_meta($post_id, $post)
    {
        ...
        if (
            !isset($_POST['coinsnap_bitcoin_donation_public_donors_nonce']) ||
            !wp_verify_nonce($_POST['coinsnap_bitcoin_donation_public_donors_nonce'], 'coinsnap_bitcoin_donation_public_donors_nonce')
        ) {
            return;
        }
